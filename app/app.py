...
<div class="alert alert-warning" role="alert">
  ...
  <p class="mb-0">
    ...
    Make sure your <strong>OPENAI_API_KEY</strong> is set in the <code>.env</code> file,
...
<div class="col-lg-6">
  <div class="card shadow-sm h-100 border-0">
    <div class="card-body">
      ...
      <small class="text-muted">Generated by GPT-3.5-turbo (OpenAI)</small>
    </div>
  </div>
</div>"""
...
{cards_html}
    ...
    return render_page(
        ...
        description=(
            f"GPT-3.5-turbo (OpenAI) generated scouting reports for the top "
